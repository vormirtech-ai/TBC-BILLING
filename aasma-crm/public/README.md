...
- To share records between the office and the site, connect a **private** GitHub
  repository in **Settings → Sync** on each computer. Every computer keeps its
  own offline copy; syncing merges them record by record, so two people working
