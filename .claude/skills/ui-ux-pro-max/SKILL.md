...
The search script lives inside this skill's own directory. Invoke it by the path below from the project root (or use the absolute path to `.claude/skills/ui-ux-pro-max/scripts/search.py` if the working directory differs):
